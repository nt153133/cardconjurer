...
public sealed class SvgRasterizationService : ISvgRasterizationService, IDisposable
{
    ...
    public SvgRasterizationService(EngineConfiguration engineConfig, IMemoryCache memoryCache)
    {
        _rasterCache = memoryCache;

        var manaRoot = Path.Combine(engineConfig.WebRootPath, "img", "manaSymbols");
